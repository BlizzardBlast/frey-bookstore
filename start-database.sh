...
DB_CONTAINER_NAME="frey-bookstore-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=frey-bookstore -d -p 5432:5432 docker.io/postgres
